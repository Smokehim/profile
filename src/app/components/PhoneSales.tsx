        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {displayedPhones.map((phone) => (
            ...
            >
              ...
              <div className="p-6">
                <p className="text-[#3b82f6] text-sm mb-2">{phone.brand}</p>
                <h3 className="text-white text-xl mb-3">{phone.name}</h3>
                <ul className="space-y-2 mb-4">
                  {phone.specs.map((spec, specIndex) => (
                    <li key={specIndex} className="text-[#94a3b8] text-sm flex items-center gap-2">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-[#334155]">
                  <span className="text-white text-2xl">{phone.price}</span>
                  <button
